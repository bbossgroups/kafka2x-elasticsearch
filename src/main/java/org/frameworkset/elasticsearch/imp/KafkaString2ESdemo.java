 ...
 * @version 1.0
 */
public class KafkaString2ESdemo {
	private static Logger logger = LoggerFactory.getLogger(KafkaString2ESdemo.class);
	public static void main(String args[]){
		KafkaString2ESdemo dbdemo = new KafkaString2ESdemo();
