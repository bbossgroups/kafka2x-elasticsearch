 ...
 * @version 1.0
 */
public class Kafka2ESdemoWithTopicDB2Kafka {
	private static Logger logger = LoggerFactory.getLogger(Kafka2ESdemoWithTopicDB2Kafka.class);
	public static void main(String args[]){
		Kafka2ESdemoWithTopicDB2Kafka dbdemo = new Kafka2ESdemoWithTopicDB2Kafka();
	...
	public void scheduleTimestampImportData(boolean dropIndice){
		...
		if(dropIndice) {
			try {
				...
				String repsonse = ElasticSearchHelper.getRestClientUtil().dropIndice("db2kafkademo");
